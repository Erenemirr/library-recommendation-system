...
- [ ] Created AWS account with Free Account Plan - Done
- [ ] Verified email address - Done
- [ ] Verified phone number - Done
- [ ] Added payment method - Done
- [ ] Received $100 sign-up credits - Done
- [ ] Enabled billing alerts - Done
- [ ] Created zero-spend budget - Done
- [ ] Set up CloudWatch billing alarm - Done
- [ ] Enabled MFA on root account - Done
- [ ] Created IAM user for daily use - Done
- [ ] Installed AWS CLI - Done
- [ ] Configured AWS CLI with access keys - Done
- [ ] Tested AWS CLI connection - Done
- [ ] Bookmarked Free Tier dashboard ---
- [ ] Reviewed Free Tier limits - Done
